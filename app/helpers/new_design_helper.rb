module NewDesignHelper
	...
	def header_path
    pages_to_show_dark_header = [root_path, new_user_session_path, retail_cloud_path, backup_cloud_path, voice_solutions_path, networking_solutions_path, bare_metal_as_service_path, vmware_cloud_solutions_path, desktop_as_service_path, faq_path, contact_us_path]
